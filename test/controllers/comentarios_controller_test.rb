...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { conteudo: @comentario.conteudo, post_id: @comentario.post_id, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { conteudo: @comentario.conteudo, post_id: @comentario.post_id, usuario_id: @comentario.usuario_id } }
